package DVDzbr::DBSchema::Result::Dvd;
...
Related object: L<DVDzbr::DBSchema::Result::User>

=cut

__PACKAGE__->belongs_to(
  "current_borrower",
  "DVDzbr::DBSchema::Result::User",
  { id => "current_borrower" },
  {
    is_deferrable => 1,
    join_type     => "LEFT",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:y3RnQV9I/tPLBTMgOSxvHA
